...
func (repo *answerRepository) Create(qna qna_models.Answers) error {
	return repo.base.Create(qna)
}

func (repo *answerRepository) List() ([]qna_models.Answers, error) {
...
func (repo *answerRepository) Update(item qna_models.Answers) error {
	return repo.base.Update(item)
}

func (repo *answerRepository) Delete(id string) error {
